...
func _ready():
	combatantModificationNode = preload("res://scenes/combatantModificationDisplay.tscn").instantiate()
	...
	combatantsDisplay = preload("res://scenes/CombatantSelection.tscn").instantiate()
